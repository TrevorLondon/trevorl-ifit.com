SELECT program, bucket, count(*), sum(count) FROM ( 
SELECT *,
        CASE WHEN program = 'Niagra' and count BETWEEN 0 and 3 THEN '1-3'
            WHEN program = 'Niagra' and count = 4 THEN '4'
            WHEN program = 'Niagra' and count BETWEEN 5 and 6 THEN '5-6'
            WHEN program = 'Niagra' and count BETWEEN 7 and 10 THEN '7-10'
            WHEN program = 'Niagra' and count > 10 THEN '>10'
            WHEN program = 'Switzerland' and count BETWEEN 0 and 4 THEN '<4'
            WHEN program = 'Switzerland' and count = 5 THEN '5'
            WHEN program = 'Switzerland' and count BETWEEN 6 and 7 THEN '6-7'
            WHEN program = 'Switzerland' and count BETWEEN 8 and 10 THEN '8-10'
            WHEN program = 'Switzerland' and count > 10 THEN '>10'
        END as "Bucket"
FROM (
...
FROM ( 
 ...
 WHERE CONVERT_TIMEZONE('America/Denver', start_minute)::date BETWEEN '2020-05-01' AND '2020-05-31'
...
--WHERE count > 0)
--GROUP BY program
GROUP BY program, bucket
ORDER BY program, bucket
